...
/***/ function(module, exports, __webpack_require__) {
	...
	var apiAuth = __webpack_require__(4); //login
	var articleCrud = __webpack_require__(6); //front end crud
	var uiDisplay = __webpack_require__(5); // ui display

	//display articles in articles tab
	var displayArticles = function displayArticles(response) {
	  console.log('displayArticles works');
	  var articles = response.articles;
	  var articleListingTemplate = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var uiDisplay = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var articleTab = function articleTab() {
	  $('.jumbotron').hide();
	  $('.sidebar-right').show();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var apiAuth = __webpack_require__(4); // to use for login baseUrl
	var indexJs = __webpack_require__(1);
	...
	var articleId = undefined; //global variable
	var getArticleId = function getArticleId(e) {
	  articleId = $(e.target).attr('data-id');
	  console.log('Article ID is', articleId);
	};

	// Edit and update article
	var editArticle = function editArticle(e) {
	  e.preventDefault();
	  if (!apiAuth.myApp.user) {
	...
	var fillUpdate = function fillUpdate(response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(27),depth0,{"name":"article","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<div>\n  "
	    + ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.articles : depth0), depth0),{"name":"articles","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n</div>\n\n\n\n\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return " "
	    + ((stack1 = container.invokePartial(__webpack_require__(27),depth0,{"name":"article","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + " ";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams,depths) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "<h1>"
	    + alias2(alias1(((stack1 = (depths[1] != null ? depths[1].helpers : depths[1])) != null ? stack1.title : stack1), depth0))
	    + " <small>"
	    ...
	    + "</p>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.articles : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n\n<!-- <p class=\"logged-in-button\" hidden>\n<button type=\"button\" class=\"logged-in-button btn btn-default edit-article-button crud-buttons\" data-toggle=\"modal\" data-target=\"#edit-article-modal\" data-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">Edit</button>\n<button type=\"button\" class=\"logged-in-button btn btn-warning delete-article-button crud-buttons\" data-toggle=\"modal\" data-target=\"#delete-article-modal\" data-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">Delete</button>\n</p> -->\n\n<div class=\"logged-in-button author\" hidden>\n  <a class=\"logged-in-button edit-article-button crud-buttons\" data-toggle=\"modal\" data-target=\"#edit-article-modal\" data-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">Edit</a>\n  &ensp;<a class=\"logged-in-button delete-article-button crud-buttons\" data-toggle=\"modal\" data-target=\"#delete-article-modal\" data-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">Delete</a>\n\n</div>\n";
